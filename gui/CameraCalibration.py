...
class CameraCalibration:
	...
	def set_f_value(self):
		...
		if isinstance(propierty_f_widget, QDoubleSpinBox):
	...
	def set_cx_value(self):
		...
		if isinstance(propierty_cx_widget, QDoubleSpinBox):
	...
	def set_cy_value(self):
		...
		if isinstance(propierty_cy_widget, QDoubleSpinBox):
	...
	def set_k1_value(self):
		...
		if isinstance(propierty_k1_widget, QDoubleSpinBox):
	...
	def set_k2_value(self):
		...
		if isinstance(propierty_k2_widget, QDoubleSpinBox):
	...
	def set_k3_value(self):
		...
		if isinstance(propierty_k3_widget, QDoubleSpinBox):
	...
	def set_k4_value(self):
		...
		if isinstance(propierty_k4_widget, QDoubleSpinBox):
	...
	def set_b1_value(self):
		...
		if isinstance(propierty_b1_widget, QDoubleSpinBox):
	...
	def set_b2_value(self):
		...
		if isinstance(propierty_b2_widget, QDoubleSpinBox):
	...
	def set_p1_value(self):
		...
		if isinstance(propierty_p1_widget, QDoubleSpinBox):
	...
	def set_p2_value(self):
		...
		if isinstance(propierty_p2_widget, QDoubleSpinBox):
